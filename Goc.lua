...
local function getPlayerData()
    ...
    pcall(function()
        ...
        for fruit, amount in pairs(fruitData) do
            if (fruit == "DoughFruit" or fruit == "DragonFruit" or fruit == "PhoenixFruit" or fruit == "ToyFruit" or fruit == "GateFruit" or fruit == "MelodyFruit") and tonumber(amount) and tonumber(amount) > 0 then
